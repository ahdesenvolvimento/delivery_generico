# Generated by Django 3.0.5 on 2020-05-31 21:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_de_entrega', models.CharField(max_length=50, verbose_name='Tipo de entrega')),
                ('cod_endereco', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.EnderecoCliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacao', models.TextField(default=None, max_length=75, null=True, verbose_name='Observação')),
                ...
                ('cod_prod', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.Produto')),
            ],
            options={
